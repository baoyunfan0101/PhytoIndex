...
| `app.css` | Desktop shell, activity bar, tabs, global search, toolbar, popovers, and status bar. |
| `shared.css` | Buttons, virtual collections, segmented controls, editor, modal, loading, and empty states. |
| `photos.css` | Photo browsers, media, folder tree, detail view, map, and photo context menu. |
...
| `settings.css` | Settings navigation, storage, libraries, naming, map, and hook-test layouts. |
