...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::inspect_sql_data_source,
            ...
            commands::create_base_import_session,
            ...
            commands::discard_base_import_session,
            commands::get_default_base_import_sql,
            commands::save_default_base_import_sql,
            commands::reset_default_base_import_sql,
